...
\textit{Beschreibungen, weicht aber unwesentlich von einander ab. \textbf{TODO}}
...
Die Verbindungen sind nicht fest vorgegeben, sondern können auch zum Beispiel eine Schleife bilden. \textbf{TODO}}
...
Diese Netzwerke agieren unüberwacht und besitzen meist die Möglichkeit sich nach dem Trainieren, \textit{noch selbst weiter anzupassen. \textbf{TODO}}
...
Das Classification Problem ist in gewisser Weise das \textit{Gegenstück \textbf{TODO}} zum Regression Problem. 
...
Ein FFN basiert auf den Grundlagen eines Neurons (Neuron \ref{sec:Neuron}), sowie dem ausbauen dieses zu Ebenen mit mehreren Neuronen \ref{sec:Layer}.
