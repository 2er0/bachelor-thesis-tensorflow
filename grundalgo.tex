...
%Paketdienste im Großen mit Abholung und Auslieferung über mehrere Tage aber auch lokale Produzenten mit direkt Zustellung ab Hof wie bei Brauereien und noch viele mehr
...
%Graph in der Logistik anders als zu TensorFlow - sind Abstrahierte Geographische Repräsentationen der Wirklichkeit
...
%\subsection{Stochastisch \& Deterministisch}

%Stochastik im Gebiet der Mathematik umfasst die Gebiete der Wahrscheinlichkeitstheorie und Statistik. 
%So werden Zufallsexperimente wie zum Beispiel ein Münzwurf analysiert und Dokumentiert. 
%Für das Analysieren stellt die Statistik die benötigten Mittel bereit. 
%
%\noindent
...
%TSP - Grundproblemstellung im Logistik
...
%Ineffizient - nicht groß vertiefen
...
%kurz erwähnen was Heuristik bedeutet
...
\end{enumerate}
%Zu Beginn des Algorithmus wird für jeden Kunden eine eigene Route erstellt. 
%Im Anschluss werden alle Kombinationen Routen erstellt und das Saving davon berechnet. 
%Durch eine absteigende Sortierung anhand des Savings lässt sich erkennen welchen Verbindung den größten Vorteil bietet. 
...
%beginnt mit großen Schritten in Richtung des Ziels, aber mit Abweichungen. 
