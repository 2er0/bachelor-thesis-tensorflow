...
In traditionellen Programmierparadigmen, wie der Sequenziellen, Prozeduralen oder Imperativen, werden eine Reihe von Operationen definiert welche in einer speziellen Reihenfolge abgearbeitet werden sollen, wie von Neumann beschrieben. 
TensorFlow wird nicht im traditionellen verwendet sonder im Sinne eines Datenflusses. 
Hierbei werden die Bewegungen von Daten in einem Modellen beschrieben. 
...
Eine Operation wird hier ausgeführt sobald alle Eingänge vorhanden sind und valide sind. 
Dies Art der Programmierung bietet von Haus aus die Möglichkeit der parallelen Ausführung, sowie ein Einfaches verteilen der Berechnungen auf ein dezentrales System. 
...
Die nächste Linie besagt, dass sich 7\% der Werte im Bereich zwischen dem geringsten und der zweiten Linie sich befinden, was inklusiv des geringsten Wertes ist.  
...
Durch die Verteilung der Werte entsteht nun der Fall, dass ein Teil der Einträge auch zu einem Wertebereich vorher oder nachher auch gehören kann. 
